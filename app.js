...
app.get("/goals", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ hostname: hostname, message: "Failed to load goals." });
  }
});
...
app.post("/goals", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ hostname: hostname, message: "Failed to save goal." });
  }
});
...
app.delete("/goals/:id", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ hostname: hostname, message: "Failed to delete goal." });
  }
});
